...
| "타임스탬프 채워줘" (완성 영상과 함께) | `.claude/skills/timestamp/SKILL.md` | 영상 전사 → 설명글에 챕터 타임스탬프 추가/교체 |
...
`01_대본.txt` (영상 제작 사이트에 업로드 — TTS → 영상 제작 진행. 정본은 `_script/script.txt`) · `02_썸네일제목.md` (제목 후보 + 썸네일 문구·이미지 프롬프트) · `03_업로드정보.md` (제목/설명글/태그/고정 댓글 + 주요 출처).
